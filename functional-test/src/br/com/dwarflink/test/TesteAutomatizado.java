...
public class TesteAutomatizado {
    ...
    //Signup form
    private static final String SIGNUP_UNAME = "username";
    private static final String SIGNUP_PSSW = "password";
    ...
    public void signupUsuarioCorreto() {
        ...
        //O usuário preenche um novo username e senha
        WebElement name = driver.findElement(By.name(SIGNUP_UNAME));
        WebElement password = driver.findElement(By.name(SIGNUP_PSSW));
        WebElement botaSubmit = driver.findElement(By.name(BTN_SUBMIT));	
...
//        name.sendKeys(USERNAME + randomComplement);
    ...
    @Test
    public void signupUsuarioIncorreto() {
        // abre firefox
        WebDriver driver = new FirefoxDriver();
        String randomComplement = "-" + RandomStringUtils.randomAscii(4);
        // O usuario acessa a homepage
